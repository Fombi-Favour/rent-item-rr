    ...
    <div className="flex flex-col justify-center items-center mt-5">
      ...
      <div className="md:w-11/12 lg:w-3/4">
        {reservationData.map((item) => {
          ...
          return (
            <div key={item.id} className="flex flex-col items-center md:flex-row md:justify-between bg-white/30 shadow-lg shadow-black/40 py-3 px-2 rounded-lg mt-5 mx-3 hover:scale-105 transition-all duration-200 delay-200">
              {/* residence image */}
              <div>
                <img src={residenceInfo.image} alt="name" className="h-52 object-cover rounded-2xl" />
              </div>
              {/* reservation information & actions */}
              <div className="w-5/6 mt-3 md:mt-0">
                {/* resevation info */}
                ...
                <div className="flex justify-around pt-4">
                  ...
                  <button type="button" className="capitalize hover:bg-red-500 text-slate-800 tracking-wide hover:text-white hover:tracking-wider font-medium hover:font-semibold border-2 border-red-500 px-3 py-2 rounded-lg transition-all duration-150 delay-200">
                    delete
                  </button>
                </div>
              </div>
